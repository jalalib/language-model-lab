...
I wanted to test if embeddings could warn someone about a scam message by 

comparing it to known scam examples.



It worked at first, but then I removed one legitimate example from my 

reference list and the same message flipped from "legitimate" to "scam" — 

even though the scam scores never changed.



So the system wasn't really detecting scams. It was checking whether I 

happened to have something similar in my list.
